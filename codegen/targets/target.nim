...
# Creating the table to store the intructions for each architure on OS type
...
proc vm_getTarget*(architecture: string = "", target: string = ""): Table[string, proc(d0: string, d1: string, d2: string): string] =
